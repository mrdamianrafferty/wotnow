...
/**
 * Deprecated: consolidated into /cookies.
 *
 * There were two of these — this one and /cookies — with separately maintained
 * text, and the footer linked to this one while /cookies carried the newer copy and
...
export const getServerSideProps: GetServerSideProps = async () => ({
  redirect: { destination: '/cookies', permanent: true },
});
