    ...
    subcategories: [
      {
        ...
        icon: "🤾‍♂️",
        acts: [
          "football_soccer","cricket","rugby","basketball_outdoor","beach_volleyball","american_football","baseball","hurling_camogie","gaelic_football","hockey","netball","ice_hockey_us",
        ],
      },
      {
        ...
        icon: "🎾",
        acts: [
          "golf","tennis","tennis_indoor","squash","badminton","table_tennis","archery","pickleball","padel",
        ],
      },
      {
        key: "Water Sports",
    ...
    subcategories: [
      {
        ...
        icon: "🧘‍♂️",
        acts: [
          "yoga", "outdoor_yoga", "meditation", "outdoor_meditation", "pilates", "martial_arts", "tai_chi",
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        icon: "🌳",
        acts: [
          "hiking", "birdwatching", "photography", "foraging", "mushroom_hunting", "stargazing",
        ],
      },
      {
        key: "Fishing",
        icon: "🎣",
        acts: [
          "fly_fishing_freshwater", "coarse_fishing", "sea_fishing_shore", "sea_fishing_boat", "ice_fishing",
        ],
      },
      {
        key: "Recreation",
        icon: "🍔",
        acts: [
          "picnicking", "bbq", "geocaching", "camping", "outdoor_reading", "dog_walking","outdoor_playground","outdoor_chess","outdoor_painting","outdoor_music", "outdoor_gym", "outdoor_meditation", "outdoor_yoga"
        ],
      },
    ],
  },
    ...
    subcategories: [
      {
        ...
        icon: "⛷️",
        acts: [
          "skiing","snowboarding","cross_country_skiing",
        ],
      },
      {
        key: "Ice Sports",
    ...
    subcategories: [
      {
        ...
        icon: "🎨",
        acts: [
          "painting", "outdoor_painting", "crafts", "photography", "knitting", "diy",
        ],
      },
      {
        ...
        icon: "🎷",
        acts: [
          "playing_records", "make_music", "dance", "outdoor_music",
        ],
      },
      {
    ...
    subcategories: [
      {
        ...
        icon: "🧶",
        acts: [
          "crafts", "knitting", "reading", "diy", "playing_records", "cooking", "painting",
        ],
      },
      {
        ...
        icon: "🍻",
        acts: [
          "going_to_pub","table_tennis","playing_cards","watch_a_movie","cafe","cinema","museum","shopping"
        ],
      },
      {
        key: "Indoor Sports",
        icon: "🏓",
        acts: [
          "indoor_climbing","squash","badminton","tennis_indoor",
          "indoor_swimming","gym_workout","pilates","yoga","meditation","dance"
        ],
      },
    ],
  },
...
const waterActivityIds = [
  "kayaking","canoeing","surfing","stand_up_paddleboarding","snorkeling","swimming","sea_fishing_shore","sea_fishing_boat","indoor_swimming"
];
      ...
      <div className="subcategories-grid">
        {mainObj.subcategories.map((sub) => (
          ...
          >
            ...
            <h3 style={{ display: "inline-block", marginRight: 12 }}>{sub.key}</h3>
