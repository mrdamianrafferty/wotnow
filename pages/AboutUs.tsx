    ...
    <div className="min-h-screen bg-base-100 text-base-content p-6 md:p-12" data-theme="wotnow">
      <div className="max-w-4xl mx-auto bg-base-200 p-8 rounded-lg shadow-lg">
        ...
        <p className="mb-4 text-base-content leading-relaxed">
          Welcome to <strong>WotNow</strong> — where it’s pretty much just one man and his dog (Bruno) running the show.
        </p>
        ...
        <p className="mb-4 text-base-content leading-relaxed">
          WotNow is born from that dream: a mission to encourage people to spend more time with others, to play, to explore,
        ...
        <p className="mb-6 text-base-content leading-relaxed">
          If you find WotNow useful or inspiring, any help, feedback, or kind words are hugely appreciated.
        ...
        <p className="mt-8 text-sm text-secondary-content">
          — The man, Bruno, and the WotNow team
        </p>
      </div>
    </div>
  );
