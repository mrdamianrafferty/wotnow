    ...
    <div className="min-h-screen bg-base-100 text-base-content p-6 md:p-12" data-theme="wotnow">
      <div className="max-w-4xl mx-auto bg-base-200 p-8 rounded-lg shadow-lg">
        ...
        <p className="mb-6 text-base-content leading-relaxed">
          At <strong>WotNow</strong>, we harness a wealth of data from widely respected APIs like OpenWeather, Open-Meteo, and Stormglass to gather detailed and specialist information about weather, marine conditions, astronomy, and even soil moisture.
        </p>
        ...
        <p className="mb-6 text-base-content leading-relaxed">
          Take the ocean as an example. Anyone can find out if the wind is blowing. But WotNow calculates the combined effects of wind speed and gusts, wind direction, wave direction, swell size and direction, and wave period. This detailed blend tells you exactly <strong>how the waves will feel at any given beach</strong>, making your planning that much smarter and more fun.
        </p>
