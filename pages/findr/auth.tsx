        ...
        <div className="card w-full max-w-md bg-base-100 shadow-2xl">
          <div className="card-body">
            ...
            <div className="space-y-3">
              {/* Google Sign-In - Hidden in PWA mode (OAuth popups don't work in standalone) */}
              {!isPWA && (
                <button
              ...
              {/* Apple Sign-In - Works in all modes */}
              <button
            ...
            <div className="text-center">
              <p className="text-sm text-base-content/70">
                {isPWA
                  ? 'Sign in securely with your Apple account. No passwords to remember!'
                  : 'Sign in securely with your Google or Apple account. No passwords to remember!'}
              </p>
              {isPWA && (
                <p className="text-xs text-base-content/50 mt-2">
                  💡 Tip: For Google Sign-In, please use the browser version at fishfindr.eu
                </p>
              )}
            </div>
