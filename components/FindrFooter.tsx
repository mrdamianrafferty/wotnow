      ...
      <div className="footer max-w-7xl mx-auto p-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="grid grid-cols-2 gap-6">
          <nav className="grid grid-flow-row gap-2" aria-label="Support links">
            <Link href="/findr/support" className="block hover:underline text-gray-800 hover:text-primary"><TranslatedText text="Support findr" /></Link>
            <Link href="/findr/how-it-works" className="block hover:underline text-gray-800 hover:text-primary"><TranslatedText text="How it works" /></Link>
            <Link href="/findr/about" className="block hover:underline text-gray-800 hover:text-primary"><TranslatedText text="About findr" /></Link>
          </nav>

          <nav className="grid grid-flow-row gap-2" aria-label="Legal links">
            <Link href="/findr/terms" className="block hover:underline text-gray-800 hover:text-primary"><TranslatedText text="Terms of use" /></Link>
            <Link href="/findr/privacy" className="block hover:underline text-gray-800 hover:text-primary"><TranslatedText text="Privacy policy" /></Link>
            <Link href="/findr/cookies" className="block hover:underline text-gray-800 hover:text-primary"><TranslatedText text="Cookie policy" /></Link>
          </nav>
        </div>
