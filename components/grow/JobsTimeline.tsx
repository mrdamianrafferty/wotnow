...
const TASK_STYLES: Record<string, TaskStyle> = {
  ...
  // Maintenance tasks
  prune: {
    color: 'text-[var(--gd-moss)]',
    bgColor: 'bg-[var(--gd-leaf)]',
    borderColor: 'border-[var(--gd-leaf)]',
    icon: Scissors,
    label: 'Prune',
  ...
  prune_winter: {
    color: 'text-[var(--gd-moss)]',
    bgColor: 'bg-[var(--gd-leaf-dark)]',
    borderColor: 'border-[var(--gd-leaf-dark)]',
    icon: Scissors,
  ...
  prune_summer: {
    color: 'text-[var(--gd-moss)]',
    bgColor: 'bg-[var(--gd-moss)]',
    borderColor: 'border-[var(--gd-moss)]',
    icon: Scissors,
