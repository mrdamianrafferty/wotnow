...
jest.mock('../../../components/translation/TranslatedFishCard', () => ({
  TranslatedFishName: ({ children }: { children: React.ReactNode }) => <span>{children}</span>,
  TranslatedText: ({ children }: { children: React.ReactNode }) => <span>{children}</span>,
}));
...
describe('ActiveSpeciesCard', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render species image when provided', () => {
      ...
      const image = screen.getByAlt('Sea Bass');
    ...
    it('should display best bait information', () => {
      render(
        <ActiveSpeciesCard
          species={defaultSpecies}
          location={defaultLocation}
    ...
    it('should display season information', () => {
      render(
        <ActiveSpeciesCard
          species={defaultSpecies}
          location={defaultLocation}
  ...
  describe('Interactions', () => {
    it('should call onAction when card is clicked', () => {
      render(
        <ActiveSpeciesCard
          species={defaultSpecies}
          location={defaultLocation}
    ...
    it('should call onAction when Enter key is pressed', () => {
      render(
        <ActiveSpeciesCard
          species={defaultSpecies}
          location={defaultLocation}
  ...
  describe('Expand/Collapse', () => {
    it('should toggle expanded state when clicking expand button', () => {
      ...
      // Find expand button (look for ChevronDown icon area)
      const buttons = screen.getAllByRole('button');
      // The expand button should be one of the buttons (not the main card)
      const expandButton = buttons.find(btn => btn !== screen.getByRole('button', { name: '' }));

      if (expandButton) {
        fireEvent.click(expandButton);
        // After expansion, calendar should be visible
