-- Fix return type for name_en (VARCHAR not TEXT)
...
COMMENT ON FUNCTION get_environmental_predictions_basic IS 'Enhanced confidence scoring with species-specific bio-band matching. All fixed: parameter names, return types, 7-day window.';
