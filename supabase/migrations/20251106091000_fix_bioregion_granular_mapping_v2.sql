...
-- Date: 2025-11-06 09:10
--
-- ROOT CAUSE: Rectangle codes were mapped to 'NE_Atlantic' but species.biogeographic_regions
-- contains granular values like 'Atlantic', 'North Sea', 'Celtic Sea', etc.
-- The filter failed because 'NE_Atlantic' != 'Atlantic', 'North Sea', etc.
--
-- SOLUTION: Map ICES rectangles to granular region names that exist in species data.
-- This is a minimal fix - only the CASE statement changes, rest is identical to working migration.
...
BEGIN
  ...
  -- Map rectangle codes to GRANULAR biogeographic regions matching species.biogeographic_regions
  -- Regions used: 'Atlantic', 'Mediterranean', 'North Sea', 'Celtic Sea', 'English Channel',
  -- 'Irish Sea', 'Bay of Biscay', 'IBI', 'Norwegian waters'
