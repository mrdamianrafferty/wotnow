-- Force Drop and Restore Working V3 Function
-- November 21, 2025
-- Aggressively drops all versions of the function and restores the working version

-- Drop with CASCADE to remove all dependencies
DROP FUNCTION IF EXISTS get_fishing_confidence_v3(text, date, integer) CASCADE;
DROP FUNCTION IF EXISTS get_fishing_confidence_v3 CASCADE;

-- Recreate the working version
