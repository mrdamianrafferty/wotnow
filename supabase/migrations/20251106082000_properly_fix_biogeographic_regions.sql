-- Properly fix biogeographic regions by DROP CASCADing all versions and recreating
...
-- Now create the ONLY version with biogeographic fix
...
BEGIN
  ...
  -- FIX: Map rectangle codes to BROAD biogeographic regions (NE_Atlantic, Mediterranean, etc.)
