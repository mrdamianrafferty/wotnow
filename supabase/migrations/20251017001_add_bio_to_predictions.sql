-- Add species_code, scientific_name, and playful_bio_en to prediction function output
-- This ensures bios are available in swipable cards for all species
...
COMMENT ON FUNCTION get_environmental_predictions_basic IS 'Enhanced confidence scoring with species-specific bio-band matching. Now includes species_code, scientific_name, and playful_bio_en for complete fish card display.';
