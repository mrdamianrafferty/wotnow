-- Fix temperature array handling in get_environmental_predictions_enhanced
-- Date: 2025-11-06 09:30
--
-- temp_opt_c is an array [min, max], not a single value
-- Need to use array indexing: temp_opt_c[1] and temp_opt_c[2]
