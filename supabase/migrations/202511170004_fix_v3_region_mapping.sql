-- Fix Confidence V3 Region Mapping
-- November 17, 2025
-- Fixes: Map CMEMS regions to biogeographic regions for seasonality join
-- Issue: ices_rectangles.region contains human-readable names like "English Channel"
--        but species_region_seasonality.region_code expects codes like "BIS", "NEA", etc.
-- Solution: Use cmems_region and map to biogeographic regions (1-to-many mapping)
