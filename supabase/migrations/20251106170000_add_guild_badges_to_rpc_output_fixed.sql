-- Add guild and species_badges to RPC output for frontend display (FIXED TYPE)
-- Date: 2025-11-06 17:00
--
-- Currently the RPC uses guild for calculations but doesn't return it.
-- Frontend needs guild (for GuildBadge display) and species_badges (for UI badges).
-- Fixed: guild is fish_guild enum type, not varchar
