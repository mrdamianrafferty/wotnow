-- Restore guild-based bio-band scoring now that guild column exists
-- Date: 2025-11-06 09:50
--
-- Now that species.guild has been added, we can use guild-specific scoring:
-- - pelagic: Sensitive to chlorophyll (open water)
-- - reef_kelp: Needs high dissolved oxygen (rocky habitats)
-- - benthic: Bottom-dwellers, oxygen sensitive
-- - surf_estuary: Tolerates varied salinity
-- - cephalopod: Moderate chlorophyll preference
...
BEGIN
  ...
  -- Map to regions matching species.biogeographic_regions
  ...
  bio_band_matches AS (
    SELECT
      be_outer.species_id,
      CASE
        -- Pelagic species: Very sensitive to chlorophyll (food availability)
        ...
        -- Reef/Kelp species: Need high dissolved oxygen (rocky habitats)
        ...
        -- Benthic species: Bottom-dwellers, oxygen important
        ...
        -- Surf/Estuary species: Tolerant of varied salinity
        ...
        -- Cephalopods: Moderate chlorophyll preference
        ...
        -- Default: Generic chlorophyll-based scoring
        ELSE (
          CASE WHEN be_outer.chlorophyll_mg_m3 BETWEEN 0.5 AND 2.0 THEN 35
               WHEN be_outer.chlorophyll_mg_m3 BETWEEN 0.3 AND 3.0 THEN 28
               WHEN be_outer.chlorophyll_mg_m3 IS NOT NULL THEN 20
