-- Fix biogeographic region mapping in get_environmental_predictions_enhanced
-- Date: 2025-11-06
--
-- Problem: The RPC function maps rectangle codes to granular regions like "English Channel",
-- "Celtic Sea", etc., but species.biogeographic_regions uses broad values like "NE_Atlantic",
-- "Mediterranean", etc. This mismatch causes no species to match except those with NULL regions.
--
-- Solution: Map ICES rectangle codes to the broad biogeographic regions that match species data.

-- Drop both versions: 8-parameter (old) and 10-parameter (Phase 2)
...
BEGIN
  ...
  -- Map rectangle codes to broad biogeographic regions that match species.biogeographic_regions
  -- These regions match what European species actually use: NE_Atlantic, Mediterranean, etc.
  rectangle_region := CASE
    ...
    -- Northeast Atlantic - Bay of Biscay and Iberian waters (20xx-29xx)
    ...
    -- Northeast Atlantic - Celtic Sea, English Channel, Irish Sea (30xx-39xx)
    ...
    -- Northeast Atlantic - North Sea (40xx-49xx)
    ...
    -- Northeast Atlantic - Norwegian Sea and Barents Sea (50xx-65xx)
