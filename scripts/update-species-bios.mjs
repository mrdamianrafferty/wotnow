// Script to update species playful_bio_en from local findrFishBios.ts
// Run with: node scripts/update-species-bios.mjs
...
// All bios from findrFishBios.ts
const BIOS = [
  // European Species
  ...
  { species: 'Cod', bio: 'Catch me when the lights go down; autumn–winter inshore peaks. Bring lug or rag and I\'m yours...' },
  { species: 'Cuttlefish', bio: 'Shine your love-light in spring. I turn up at dusk and night — swipe right if you\'ve got cuttle/squid jigs...' },
  ...
  { species: 'Common Dentex', bio: 'Daytime hunter over reefs. Let\'s keep it casual — lively fish baits and a tide change are enough...' },
  { species: 'Dover Sole', bio: 'I flat-out love the night on clean sand. Swipe right if you\'ve got worms...' },
  { species: 'Grey Mullet', bio: 'Catch me at dawn or evening on calm days. I love a chase… that ends with bread...' },
  ...
  { species: 'European Flounder', bio: 'Meet me in murky water when the lights go down; autumn–winter is my season. Worms plus a tide change get me...' },
  { species: 'Garfish', bio: 'Surface socialite by day and dusk; under lights at night too. Not into small talk — only small float baits or tiny lures...' },
  ...
  { species: 'Atlantic Herring', bio: 'When the lights go down in winter and spring, I shine. Really into fine nets and small sabikis...' },
  { species: 'Horse Mackerel', bio: 'Dusk to night under lights; first light too. Tiny lures or sabikis — keep it lively...' },
  { species: 'Scad', bio: 'Dusk to night under lights; first light too. Tiny lures or sabikis — keep it lively...' },
  ...
  { species: 'Atlantic Mackerel', bio: 'Sun\'s out, shoals in; dawn/evening peaks in summer. Sucker for feathers and fast retrieves...' },
  ...
  { species: 'European Plaice', bio: 'Sun on my back by day; I\'ll stay out late too. A nice worm works every time...' },
  ...
  { species: 'Common Pandora', bio: 'Sun-lover with serious appetite. Always hungry — bring crab...' },
  { species: 'Saithe', bio: 'Dawn/dusk prowler; overcast days sing with lures. Swipe right for metal jigs...' },
  { species: 'Coalfish', bio: 'Dawn/dusk prowler; overcast days sing with lures. Swipe right for metal jigs...' },
  { species: 'Sand Eel', bio: 'Daylight or dusk when my gang runs beaches; under lights in some harbours. Show me tiny sabikis...' },
  { species: 'Sandeel', bio: 'Daylight or dusk when my gang runs beaches; under lights in some harbours. Show me tiny sabikis...' },
  ...
  { species: 'European Bass', bio: 'On the prowl at dawn/dusk in warm spells or after a blow. Love a chase — end it with crab...' },
  { species: 'European Seabass', bio: 'On the prowl at dawn/dusk in warm spells or after a blow. Love a chase — end it with crab...' },
  { species: 'Sea Trout', bio: 'Dawn/dusk chaser; at night in clear, calm conditions. Spin me or fly me — your call...' },
  { species: 'Lesser Spotted Catshark', bio: 'Night crawler on mixed ground. Love a moonlit dinner — smelly fish or squid, don\'t be shy...' },
  { species: 'Dogfish', bio: 'Night crawler on mixed ground. Love a moonlit dinner — smelly fish or squid, don\'t be shy...' },
  ...
  { species: 'Turbot', bio: 'Dawn/dusk drifts along sandbank shoulders. Whole sandeel gets me every time...' },
  ...
  { species: 'Wrasse (various)', bio: 'Daylight feeder over rocky kelp; flood tide is prime. Swipe right if you\'ve got crab, prawn, or limpet...' },
  ...
  { species: 'Gray Snapper', bio: 'Dusk/night around structure year-round. Not into small talk — live shrimp works every time...' },
  ...
  { species: 'Pacific Sierra', bio: 'Early morning surface chaser in warm months. Metal spoons and I\'m done for.' },
  ...
  { species: 'Yellowtail', bio: 'Sunrise and sunset year-round. Livebaits or jigs — either way, keep it moving...' },
  ...
  { species: 'Yellowfin Goatfish', bio: 'Daylight bottom browser on sand near reefs. Small shrimp or cut fish — simple as that...' },
  { species: 'Common Thresher Shark', bio: 'Dawn and late afternoon offshore. Whole mackerel or live bait — go big...' },
  { species: 'California Corbina', bio: 'Dawn/dusk surf cruiser on sandy beaches. Blood worms or sand crabs are my jam...' },
  { species: 'Tarpon', bio: 'Dawn/dusk and night in warm months. Livebaits or flies — show me what you\'ve got...' },
  { species: 'Dog Snapper', bio: 'Dusk to night around rocky structure. Live or cut bait with a moving tide works...' },
  { species: 'Nassau Grouper', bio: 'Dawn/dusk on reef ledges. Livebaits preferred — whole fish if you\'re serious...' },
  { species: 'Pacific Red Snapper', bio: 'Early morning and late afternoon on rocky reefs. Cut bait or small lures get my attention...' },
  { species: 'White Seabass', bio: 'Dawn/dusk and night spring to fall. Live squid or sardines — don\'t show up empty-handed...' },
  ...
  { species: 'Albacore', bio: 'Early morning offshore summer to fall. Fast trolls or jigs — keep it moving...' },
  ...
  { species: 'Scamp', bio: 'Dawn/dusk deep reef resident. Livebaits or cut fish with a moving tide — I\'m in...' },
  ...
  { species: 'Gray Jobfish', bio: 'Dawn and late afternoon on deep reefs. Small fish or squid strips — keep it simple...' },
  { species: 'Cero Mackerel', bio: 'Early morning reef runner spring to summer. Fast lures or live pilchards seal the deal...' },
  { species: 'Cero', bio: 'Early morning reef runner spring to summer. Fast lures or live pilchards seal the deal...' },
  ...
  { species: 'Atlantic Tripletail', bio: 'Daylight drifter near surface structure. Live shrimp or small crabs get my attention...' },
  { species: 'Stone Crab', bio: 'Night forager on hard bottom. Fish heads or chicken — not picky about cuisine...' },
  { species: 'Florida Stone Crab', bio: 'Night forager on hard bottom. Fish heads or chicken — not picky about cuisine...' },
  { species: 'Common Snook', bio: 'Dawn/dusk mangrove cruiser on moving tide. Live pilchards or plugs — let\'s do this...' },
  { species: 'Snook', bio: 'Dawn/dusk mangrove cruiser on moving tide. Live pilchards or plugs — let\'s do this...' },
  { species: 'Chinook Salmon', bio: 'Dawn and late afternoon fall to spring. Herring, anchovies, or spoons — show me flash...' },
  { species: 'King Salmon', bio: 'Dawn and late afternoon fall to spring. Herring, anchovies, or spoons — show me flash...' },
  ...
  { species: 'Silver Salmon', bio: 'Dawn/dusk fall coastal runs. Spoons, spinners, or herring — keep it shiny...' },
  ...
  { species: 'Crevalle Jack', bio: 'Dawn/dusk power hunter year-round. Topwater plugs or livebait — I love a good fight...' },
  { species: 'Florida Pompano', bio: 'Daylight surf dweller on sandy beaches. Sand fleas or small jigs work wonders...' },
  { species: 'Pompano', bio: 'Daylight surf dweller on sandy beaches. Sand fleas or small jigs work wonders...' },
  { species: 'Mahi-mahi', bio: 'Daylight offshore beauty spring to fall. Livebaits, poppers, or flashy lures — surprise me...' },
  { species: 'Dorado', bio: 'Daylight offshore beauty spring to fall. Livebaits, poppers, or flashy lures — surprise me...' },
  { species: 'Dolphinfish', bio: 'Daylight offshore beauty spring to fall. Livebaits, poppers, or flashy lures — surprise me...' },
  ...
  { species: 'Fluke', bio: 'Daylight and dusk spring to fall. Live minnows or squid strips seal the deal...' },
  { species: 'Golden Tilefish', bio: 'Daylight deep canyon dweller. Cut squid or clams — I\'m not complicated...' },
  { species: 'Tilefish', bio: 'Daylight deep canyon dweller. Cut squid or clams — I\'m not complicated...' },
  ...
  { species: 'Menhaden', bio: 'Daylight schooling filter feeder. Castnet territory — more bait than catch...' },
  ...
  { species: 'Shortfin Mako Shark', bio: 'Daylight offshore speed demon. Whole mackerel or fast-moving lures — let\'s race...' },
  ...
  { species: 'Striper', bio: 'Dawn/dusk coastal cruiser spring and fall. Livebaits, plugs, or eels — I love variety...' },
...
async function updateBios() {
  console.log(`Updating ${BIOS.length} species bios...\n`);
  
  let updated = 0;
  let notFound = 0;
  let errors = 0;
  
  for (const { species, bio } of BIOS) {
    const { data, error } = await supabase
      .from('species')
      .update({ playful_bio_en: bio })
      .ilike('name_en', species)
      .select('name_en');
    
    if (error) {
      console.error(`❌ Error updating ${species}:`, error.message);
      errors++;
    } else if (data && data.length > 0) {
      console.log(`✅ Updated: ${data.map(d => d.name_en).join(', ')}`);
      updated += data.length;
    } else {
      console.log(`⚠️  Not found: ${species}`);
      notFound++;
    }
  }
...
updateBios().catch(console.error);
