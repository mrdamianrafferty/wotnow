...
new: [
    ...
    { title: 'Lucky Glimpse', text: 'Spotting the new moon over your right shoulder is thought to bring fortune.', culture: 'general' },
    ...
    { title: 'No Travel Day', text: 'Indian villagers often avoid setting out on long journeys during new moon, fearing misfortune.', culture: 'general', key: 'india-new-notravel' },
    { title: 'Seed Rest', text: 'Some Indian farmers refrain from sowing during new moon, calling it infertile ground-time.', culture: 'general', key: 'india-new-noplants' },
    ...
    // China
    { title: 'Ancestor Cleanse', text: 'New moon nights in China are for cleaning ancestral tablets and household altars to welcome new blessings.', culture: 'chinese', key: 'china-new-ancestor-cleanse' },
    { title: 'Seed Selection', text: 'Farmers mark the new moon in China as the time to select seeds for planting to ensure strong crops.', culture: 'chinese', key: 'china-new-seed-selection' },
    { title: 'Quiet Waters', text: 'Chinese fishermen wait for the new moon to launch boats, believing the waters will be calm and bountiful.', culture: 'chinese', key: 'china-new-quiet-waters' },
  ...
  waxing_crescent: [
    { title: 'Growth Energy', text: 'The waxing crescent has been linked with growth — projects, ambitions, and crops alike.', culture: 'general' },
    { title: 'Love Lore', text: 'On St. Agnes’ Eve, gazing at a waxing crescent was said, in Ireland, to bring dreams of your true love.', culture: 'irish' },
    ...
    { title: 'Plantain Shoots', text: 'Caribbean gardeners plant quick-growing greens under a waxing moon foand,r leafy abundance.', culture: 'caribbean' },
    ...
    // India
    { title: 'Shubha Tithi', text: 'In the Hindu calendar, first crescent days are called favourable (shubha), good for new household tasks and minor rituals.', culture: 'general', key: 'india-crescent-shubha' },
    { title: 'Cow Calf Luck', text: 'Farmers in India bless calves born under waxing moons as strong and milk-rich.', culture: 'general', key: 'india-crescent-cows' },
    { title: 'Lantern Nights', text: 'Indian villages used to light tiny lamps when the crescent returned, greeting its growth.', culture: 'general', key: 'india-crescent-lamps' },
    { title: 'Scribal Moon', text: 'Accounts were traditionally opened in India when the new crescent grew, thought to bring gain.', culture: 'general', key: 'india-crescent-accounts' },

    // China
    { title: 'Silver Moon Tea', text: 'A tea ceremony in China celebrates the waxing crescent moon, symbolizing growth and harmony.', culture: 'chinese', key: 'china-crescent-tea' },
    { title: 'Sprouting Rice', text: 'Chinese farmers watch the crescent moon for the best time to start rice sprouting.', culture: 'chinese', key: 'china-crescent-sprouting-rice' },
    { title: 'Lantern Blessings', text: 'Lanterns are lit early in the waxing crescent to bless Chinese households with light and luck.', culture: 'chinese', key: 'china-crescent-lanterns' },
  ],
  first_quarter: [
    { title: 'Balance Point', text: 'The half-lit moon symbolises balance between light and dark, decision and challenge.', culture: 'general' },
    ...
    // India
    { title: 'Field Turning', text: 'Tilling at the half-moon was thought to balance soil energies in India.', culture: 'general', key: 'india-quarter-tilling' },
    ...
    { title: 'Village Fairs', text: 'Many village melas in India timed stalls at the half-moon, balancing trade and leisure.', culture: 'general', key: 'india-quarter-fair' },

    // China
    { title: 'Mid-Qing Ritual', text: 'Mid-quarter moon in China is a time for balancing yin and yang energies through quiet rituals.', culture: 'chinese', key: 'china-quarter-yinyang' },
    { title: 'Tilling Timing', text: 'The first quarter moon signals the ideal time to begin tilling for healthful soil in China.', culture: 'chinese', key: 'china-quarter-tilling' },
    { title: 'Ancestor Feast', text: 'Chinese families hold modest feasts for ancestors, appreciating their guidance at the half-moon.', culture: 'chinese', key: 'china-quarter-ancestor-feast' },
  ],
waxing_gibbous: [
    ...
    { title: 'Bridal Moon', text: 'Indian astrologers recommended waxing gibbous phases for wedding ceremonies to ensure prosperity.', culture: 'general', key: 'india-gibbous-weddings' },
    { title: 'Rice Sprouts', text: 'Indian farmers believed transplanted rice tillers best under gibbous moons.', culture: 'general', key: 'india-gibbous-rice' },

    // China
    { title: 'Tea Harvest', text: 'Tea gardens in China prepare for harvest during waxing gibbous moon for best flavor.', culture: 'chinese', key: 'china-gibbous-tea-harvest' },
    { title: 'Silkworm Feeding', text: 'Chinese silkworm farmers feed larvae under swelling moons to boost silk quality.', culture: 'chinese', key: 'china-gibbous-silkworm' },
    { title: 'Soup Brewing', text: 'Chinese medicinal soups are brewed during the gibbous phase to absorb the moon’s nourishing energy.', culture: 'chinese', key: 'china-gibbous-soup' },
  ],
full: [
    ...
    // India
    { title: 'Guru Purnima', text: 'The full moon of July is celebrated by Hindus to honour teachers and mentors.', culture: 'general', key: 'india-full-gurupurnima' },
    { title: 'Holi Moon', text: 'The colourful Hindu Holi festival is tied to the full moon of Phalguna month.', culture: 'general', key: 'india-full-holi' },
    ...
    { title: 'Sharad Beauty', text: 'The autumn harvest full moon is praised in Indian poetry as “Sharad purnima,” when dew turns nectar-sweet.', culture: 'general', key: 'india-full-sharad' },
    ...
    // China
    { title: 'Full Moon Dance', text: 'Chinese villages perform traditional dance and music to honor the full moon’s power.', culture: 'chinese', key: 'china-full-dance' },
    { title: 'Rice Blessing', text: 'Farmers in China offer first rice harvest gifts to the moon deity on mid-autumn.', culture: 'chinese', key: 'china-full-rice-blessing' },
    { title: 'Full Moon Meditation', text: 'Meditative practices in China intensify under the full moon to harness lunar energy.', culture: 'chinese', key: 'china-full-meditation' },
    { title: 'Lantern Release', text: 'Releasing lanterns into the sky symbolizes sending prayers to ancestors in China.', culture: 'chinese', key: 'china-full-lantern-release' },
  ],
...
waning_gibbous: [
    ...
    // India
    { title: 'Debt Clearing', text: 'Some Indian traders settle debts in waning bright days, lest growth turn to decline.', culture: 'general', key: 'india-gibbous-debts' },
    ...
    { title: 'Children’s Games', text: 'Indian folklore says children should not play too much after full moon, lest spirits tire them.', culture: 'general', key: 'india-gibbous-children' },

    // China
    { title: 'Herb Drying', text: 'Medicinal herbs are harvested in China before waning gibbous to cure ailments.', culture: 'chinese', key: 'china-gibbous-herb-drying' },
    { title: 'Clay Pot Mending', text: 'Chinese families mend clay pots to avoid breakage during waning phases.', culture: 'chinese', key: 'china-gibbous-pot-mending' },
  ],
...
last_quarter: [
    ...
    // India
    { title: 'Tulsi Pruning', text: 'Sacred Hindu basil plants (Tulsi) are trimmed at the waning half to prevent overgrowth.', culture: 'general', key: 'india-quarter-tulsi' },
    { title: 'Penance Time', text: 'Hindu ascetics observed austerities during waning halves, when ego should diminish.', culture: 'general', key: 'india-quarter-penance' },

    // China
    { title: 'Luck Renewal', text: 'Cleaning at last quarter is believed to renew fortune and remove bad energy in China.', culture: 'chinese', key: 'china-quarter-luck-renewal' },
    { title: 'Quiet Reflection', text: 'Chinese villagers take the last quarter moon for quiet thought and planning.', culture: 'chinese', key: 'china-quarter-reflection' },
  ],
waning_crescent: [
    ...
    // India
    { title: 'Ancestor Thread', text: 'Tying sacred thread is avoided by Hindus in waning crescents; life-rites wait for new moon or waxing return.', culture: 'general', key: 'india-crescent-thread' },
    { title: 'Spirits Walk', text: 'Villagers in India warn the thin waning crescent is when preta (unquiet souls) roam most strongly.', culture: 'general', key: 'india-crescent-preta' },
    { title: 'End-of-Month Sweep', text: 'Indian houses are broomed clean before the dark moon, to bring fresh fortune in.', culture: 'general', key: 'india-crescent-sweep' },
    { title: 'Moon Fasting', text: 'Hindu women take crescent waning nights for light fasting, thought to purify ahead of renewal.', culture: 'general', key: 'india-crescent-fast' },

    // China
    { title: 'Soft Prayers', text: 'The fading crescent is a time in China for soft, silent prayers and soul rest.', culture: 'chinese', key: 'china-crescent-soft-prayers' },
    { title: 'Window Washing', text: 'Washing windows before the new moon is done to bring clarity and fresh fortune in China.', culture: 'chinese', key: 'china-crescent-window-washing' },
...
// Returns a single random lore item for a given phase
export function getRandomMoonLore(phase: MoonPhase): LoreItem | undefined {
